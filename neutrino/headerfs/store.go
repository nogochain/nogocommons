...
// BlockLocator is a slice of block header hashes used to locate a specific
// point in the block chain. Defined locally to avoid a circular dependency
// with nogocore/blockchain.
...
//
// NOTE: Part of the BlockHeaderStore interface.
func (h *blockHeaderStore) LatestBlockLocator() (BlockLocator, error) {
	// Lock store for read.
	h.mtx.RLock()
	defer h.mtx.RUnlock()
