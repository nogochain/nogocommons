...
import (
	...
	"github.com/nogochain/nogocommons/address/bech32"
...
func NewAddressPubKey(serializedPubKey []byte, net *chaincfg.Params) (*AddressPubKey, error) {
	pubKey, err := nogoec.ParsePubKey(serializedPubKey)
	if err != nil {
		return nil, err
	}
...
func (a *AddressPubKey) PubKey() *nogoec.PublicKey {
	return a.pubKey
}
...
//  The same constant is exported as PayToAnchorScript;
