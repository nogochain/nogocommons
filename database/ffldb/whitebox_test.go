...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*nogoutil.Block, error) {
	...
	blocks := make([]*nogoutil.Block, 0, 256)
	genesis := nogoutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
