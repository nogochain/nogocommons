...
const (
	...
	// or decrypted.
	//
	// The test vectors specify encrypting 16777215 bytes, while bitcoind
	// decrypts up to 1 + 12 + 4_000_000 bytes by default. The maximum
	// chunk size is set to match the reference implementation.
