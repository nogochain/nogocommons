...
// Tx returns a wrapped transaction (nogoutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (nogoutil.Tx) for all
...
// instead provides easy access to wrapped versions (nogoutil.Tx) of them.
...
func NewBlockFromBytes(serializedBlock []byte) (*Block, error) {
	...
	// This initializes []nogoutil.Tx to have the serialized raw
