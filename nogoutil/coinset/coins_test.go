...
import (
	...
	"github.com/nogochain/nogocommons/nogoutil/coinset"
...
func NewCoin(index int64, value nogoutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = nogoutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = nogoutil.NewTxFromBytes(testSimpleCoinTxBytes)
