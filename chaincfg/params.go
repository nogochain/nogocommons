...
var MainNetParams = Params{
	...
	DefaultPort: "19444",
	DNSSeeds: []DNSSeed{
		{Host: "seed1.nogochain.org", HasFiltering: true},
		{Host: "seed2.nogochain.org", HasFiltering: true},
		{Host: "seed3.nogochain.org", HasFiltering: true},
		{Host: "seed1.nogochain.com", HasFiltering: true},
		{Host: "seed2.nogochain.com", HasFiltering: true},
		{Host: "seed3.nogochain.com", HasFiltering: true},
	},
...
var TestNet3Params = Params{
	...
	DefaultPort: "19555",
	DNSSeeds: []DNSSeed{
		{Host: "testnet-seed1.nogochain.org", HasFiltering: true},
		{Host: "testnet-seed2.nogochain.org", HasFiltering: true},
		{Host: "testnet-seed3.nogochain.org", HasFiltering: true},
		{Host: "testnet-seed1.nogochain.com", HasFiltering: true},
		{Host: "testnet-seed2.nogochain.com", HasFiltering: true},
		{Host: "testnet-seed3.nogochain.com", HasFiltering: true},
	},
	GenesisBlock: &nocoGenesisBlock,
