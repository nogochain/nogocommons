...
func NewSignature(r, s *nogoec.ModNScalar) *Signature {
...
func SignCompact(key *nogoec.PrivateKey, hash []byte,
...
func RecoverCompact(signature, hash []byte) (*nogoec.PublicKey, bool, error) {
...
// and BIP0062.
func Sign(key *nogoec.PrivateKey, hash []byte) *Signature {
